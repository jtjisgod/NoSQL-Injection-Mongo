...
<body>
        <form method="POST" action="update_regist.php">
            <div id="form">
                <div id="title">Member Registraion</div>
                ...
                <div><input type="text" name="password2" id="password2" placeholder="PASSWORD CHECK"></div>
                <div><button id="btnLogin">SIGN UP</button></div>
            </div>
            <div id="formBottom" class="row">
                <div class="col"><span><a href="javascript:alert('boop');">Forgot Password?</a></span></div>
                <div class="col"><span><a href="index.php">Login</a></span></div>
            </div>
    </form>
</body>
</html>